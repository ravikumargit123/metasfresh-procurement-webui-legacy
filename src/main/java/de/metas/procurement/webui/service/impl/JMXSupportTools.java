...
@Service
@ManagedResource(objectName = "de.metas.procurement.webui:type=JMXSupportTools", description = "Supposed to make support tasks easier by allowing select and display certain records")
